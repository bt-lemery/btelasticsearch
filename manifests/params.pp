...
class btelasticsearch::params {
  ...
  case $::kernel {
    'Linux': {
      $btelasticsearch_user  = 'elasticsearch'
      $btelasticsearch_group = 'elasticsearch'
    }
    'Darwin': {
      $btelasticsearch_user  = 'elasticsearch'
      $btelasticsearch_group = 'elasticsearch'
    ...
    'OpenBSD': {
      $btelasticsearch_user  = '_elasticsearch'
      $btelasticsearch_group = '_elasticsearch'
    }
    default: {
